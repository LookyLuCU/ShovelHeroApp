...
public class GuardianViewApprovedWOActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guardian_view_approved_woactivity);

        Button buttonCancelOrder = findViewById(R.id.btnCancelGuardian);
