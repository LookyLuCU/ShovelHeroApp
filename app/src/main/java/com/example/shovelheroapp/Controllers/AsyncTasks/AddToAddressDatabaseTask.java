...
public class AddToAddressDatabaseTask extends AsyncTask<User.Address, Void, Void> {
    ...
    @Override
    protected Void doInBackground(User.Address... params) {
        if (params.length > 0) {
            User.Address address = params[0];
